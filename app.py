...
with tab1:
    ...
    # Ubah format TTR CUSTOMER dari "47:24:41" ke "47 jam 24 menit"
    ...
    # Ubah format LAST UPDATE WORKLOG dari "2026-03-01 08:11:49.399" ke "08:11"
    def format_last_update_worklog(val):
        try:
    ...
    df_display["LAST UPDATE WORKLOG"] = df_display["LAST UPDATE WORKLOG"].apply(format_last_update_worklog)
